...
export const translationData: Record<Language, Record<string, any>> = {
  fr: {
    ...
    tracking: {
      ...
      updateAvailable: 'Mise à jour du suivi disponible!',
      updateDescription: 'Votre colis a été mis à jour. Actualisez pour voir les dernières informations.',
      refresh: 'Actualiser',
      ...
      paid: 'Payé',
      fragile: 'Fragile',
      dangerousGoods: 'Matières dangereuses',
      signatureRequired: 'Signature requise',
      noSpecialRequirements: 'Aucune spécification particulière'
    },
  ...
  es: {
    ...
    tracking: {
      ...
      packagePhotos: 'Fotos del paquete',
      ...
      noSpecialRequirements: 'Sin especificaciones particulares'
    },
  ...
  de: {
    ...
    tracking: {
      ...
      search: 'Suchen',
      notFound: 'Keine Sendung mit diesem Code gefunden',
      help: 'Benötigen Sie Hilfe?',
      format: 'Format des Verfolgungscodes:',
      formatExample: 'LOG + 9 Ziffern (z.B.: LOG123456789)',
      testCodes: 'Testcodes:',
      testCodesExample: 'LOG123456789, LOG987654321',
      updateAvailable: 'Tracking-Update verfügbar!',
      updateDescription: 'Ihr Paket wurde aktualisiert. Aktualisieren Sie für die neuesten Informationen.',
      refresh: 'Aktualisieren',
      processing: 'In Bearbeitung',
      searchError: 'Fehler bei der Suche',
      realTimeLocation: 'Echtzeit-Standort',
      activeTracking: 'Aktives Tracking',
      ...
      deliveryPhoto: 'Lieferfoto',
      receivedBy: 'Empfangen von',
      deliveredOn: 'Geliefert am',
      signatureCapture: 'Unterschrift erfassen',
  ...
  it: {
    ...
    tracking: {
      ...
      testCodesExample: 'LOG123456789, LOG987654321',
      updateAvailable: 'Aggiornamento tracciamento disponibile!',
      updateDescription: 'Il tuo pacco è stato aggiornato. Aggiorna per vedere le informazioni più recenti.',
      refresh: 'Aggiorna',
      processing: 'In elaborazione',
      searchError: 'Errore durante la ricerca',
      realTimeLocation: 'Posizione in tempo reale',
      activeTracking: 'Tracciamento attivo',
      generalInfo: 'Informazioni generali',
      trackingNumber: 'N° di tracciamento',
      type: 'Tipo',
      weight: 'Peso',
      dimensions: 'Dimensioni',
      estimatedDelivery: 'Consegna stimata',
      senderReceiver: 'Mittente e Destinatario',
      sender: 'Mittente',
      receiver: 'Destinatario',
      packagePhotos: 'Foto del pacco',
      proofOfDelivery: 'Prova di consegna',
      deliveryPhoto: 'Foto di consegna',
      receivedBy: 'Ricevuto da',
      deliveredOn: 'Consegnato il',
      signatureCapture: 'Cattura firma',
      signature: 'Firma',
      ...
      paid: 'Pagato',
      fragile: 'Fragile',
      dangerousGoods: 'Merci pericolose',
      signatureRequired: 'Firma richiesta',
      noSpecialRequirements: 'Nessuna specifica particolare'
    },
  ...
  pt: {
    ...
    tracking: {
      ...
      testCodesExample: 'LOG123456789, LOG987654321',
      updateAvailable: 'Atualização de rastreamento disponível!',
      updateDescription: 'Seu pacote foi atualizado. Atualize para ver as informações mais recentes.',
      refresh: 'Atualizar',
      ...
      trackingNumber: 'N° de rastreamento',
      type: 'Tipo',
      weight: 'Peso',
      ...
      paid: 'Pago',
      fragile: 'Frágil',
      dangerousGoods: 'Mercadorias perigosas',
      signatureRequired: 'Assinatura necessária',
      noSpecialRequirements: 'Nenhuma especificação particular'
    },
